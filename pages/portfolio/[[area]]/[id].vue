          ...
          <div class="flex justify-between">
            <div v-if="previousProject" class="flex flex-row justify-start">
              <NuxtLink :to="'/portfolio/' + linkPrevious"
                class="flex-1 text-color-1000 md:text-lg text-sm font-bold flex md:space-x-2 items-center hover:transform hover:scale-105 hover:text-color-700 transition duration-200">
