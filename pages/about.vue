...
<template>
    ...
    <div class="card" id="whoweare">
        <div class="content-section">
            <h2>Who we are</h2>
            <p>Venture Capital is a fictional investment management company that specializes in providing funding to early-stage and high-growth potential businesses. As a venture capital firm, it seeks out innovative and promising startups and provides them with financial backing in exchange for an equity stake in the company. Venture Capital plays a vital role in the entrepreneurial ecosystem by supporting entrepreneurs and helping them scale their businesses. Through careful due diligence and analysis, Venture Capital aims to identify startups with significant market potential and help them navigate the challenges of growth by offering not just capital but also strategic guidance and industry connections. By leveraging its expertise and network, Venture Capital aims to maximize returns on its investments and contribute to the success of the companies it supports.</p>
