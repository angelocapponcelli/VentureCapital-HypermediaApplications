<!--template>
  <nav class="flex bg-color-400 text-color-900 py-1 px-36" aria-label="Breadcrumb">
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
      <li class="inline-flex items-center">
        <a href="#" class="text-sm text-color-1000 hover:text-color-700 inline-flex items-center">
      ...
      <li>
        <div class="flex items-center">
          ...
          <a href="#" class="text-sm text-color-1000 hover:text-color-700 ml-1">Portfolio</a>
        </div>
      </li>
      ...
      <li aria-current="page">
        <div class="flex items-center">
          ...
          <span class="text-sm text-color-1000 ml-1 font-medium">Most relevant projects</span>
        </div>
      </li>
    </ol>
  </nav>
